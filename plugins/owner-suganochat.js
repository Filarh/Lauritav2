...
for (let id of chats) { 
conn.sendButton(id, `😚¿Te gusta hablar conmigo?😚 puedes hablar con alguien real
anónimamente sin salir de whatsapp gracias a una de mis funciones 😏 c:
`, null, null, [['🌞INTENTARLO🌟', '.start']], false, null)}
